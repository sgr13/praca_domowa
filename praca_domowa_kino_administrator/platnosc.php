    ...
    <body>
        <div id="container">
            ...
            <div id="content">
                ...
                $sql = "SELECT * FROM Bilet b LEFT JOIN Platnosc p ON b.id_platnosc=p.id";
                $result = $connettion->query($sql);
                $table = 'Bilet';

                echo "<table>";
                echo "<tr>";
                echo "<th>Id</th><th>Ilość</th><th>Cena</th><th>Płatność</th><th>Data</th>";
                echo "</tr>";
                foreach ($result as $value) {
                    $id = $value['id'];
                    echo "<tr>" . "<td>" . $value['id'] . "</td><td>" . $value['ilosc'] . "</td><td>" .
                    $value['cena'] . "zł.</td><td>" . $value['typ'] . "</td><td>" . $value['data'] .
                    "</td></tr>";
                }
                echo "</table>";
                $connettion->close();
